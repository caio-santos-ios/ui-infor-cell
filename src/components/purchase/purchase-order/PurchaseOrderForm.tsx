...
export default function PurchaseOrderForm({id}: TProp) {
  ...
  return (
    <>    
      <div className="flex items-center font-medium gap-2 rounded-lg transition  px-2 py-2 text-sm border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3 mb-3">
        {
          tabs.map((x: any) => {
