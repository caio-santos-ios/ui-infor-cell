                    ...
                    <TableBody className="divide-y divide-gray-100 dark:divide-white/5">
                      {pagination.data.map((x: any) => (
                        <TableRow key={x.id}>
                          ...
                          <TableCell className="px-5 py-4 sm:px-6 text-start text-gray-500 dark:text-gray-400">{!x.sellerName ? x.userName : x.sellerName}</TableCell>
                          ...
                          <TableCell className="px-5 py-4 sm:px-6 text-start text-gray-500 dark:text-gray-400">
                            <div className="flex gap-3">       
                              ...
                              {
                                permissionUpdate("A", "A3") && x.status == "Rascunho" &&
                                <IconEdit action="edit" obj={x} getObj={getObj}/>
                              }   
                              {
                                permissionDelete("A", "A3") && x.status == "Rascunho" &&
