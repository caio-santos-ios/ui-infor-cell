...
type TProp = { 
  productId?: string; 
  sendVariations: (variations: any[]) => void;
...
export default function VariationForm({ productId, sendVariations, btnAdd = true, btnDelete = true, btnEdit = true, btnSave = true, qtdStock = 0, stockDisabled = false, lineDefault = 1, typeBtnSave = "submit", sendBody}: TProp) {
  ...
  const update = () => {
    ...
    sendVariations(body.variations);
